...
title: "Markdown"
date: 2019-03-11
description: "Artigo de exemplo mostrando a sintaxe básica de Markdown e formatação para elementos HTML."
tags: ["markdown", "css", "html", "exemplo"]
type: 'sample'
---

Este artigo oferece uma amostra da formatação básica de Markdown que pode ser usada no Blowfish, também mostra como alguns elementos HTML básicos são decorados.
...
[^1]: A citação acima é um trecho da [palestra `sobre` nada](https://www.youtube.com/watch?v=PAAkCSZUG1c) de Rob Pike durante o Gopherfest, em 18 de novembro de 2015.
...
Além do [Shortcode Figure]({{< ref "../../docs/shortcodes#figure" >}}), você pode definir imagens usando a seguinte sintaxe Markdown:
...
Você também pode aproveitar os ['atributos Markdown'](https://gohugo.io/content-management/markdown-attributes/) do Hugo para adicionar atributos personalizados ao elemento HTML criado.
...
Note que o recurso de 'atributos Markdown' requer configuração do renderizador Goldmark.
