...
| `disableFeaturedImageProcessing`| `false`     | When the Front Matter provides a featuredimage, prevent Hugo from rendering the FeaturedImage and keep the original URL output.                                                                                                                                                                                               |
