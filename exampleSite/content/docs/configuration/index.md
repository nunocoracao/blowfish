...
| `verification.fediverse` | _Not set_ | The Mastodon handle to include in the site metadata. Include the server domain in the username, e.g. `@you@instanceaddress.tld` |
<!-- prettier-ignore-end -->
