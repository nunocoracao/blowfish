...
Blowfish offre diversi schemi di colore predefiniti. È possibile passare da uno schema all’altro utilizzando il selettore di temi integrato, che mostra tutti gli schemi disponibili.

Per impostare uno schema predefinito per il sito, configurare il parametro `colorScheme` nelle impostazioni del tema:
